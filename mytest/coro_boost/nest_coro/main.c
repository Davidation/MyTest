...
void foo_fn1(boost::context::detail::transfer_t t)
{
    ...
    foo2_tf = boost::context::detail::jump_fcontext(foo2_tf.fctx, &z);

	int *y = (int *)t.data;
    printf("back f1 %d %d %lx %lx\n", *x, *y, t.fctx, foo2_tf.fctx);
    ...
    boost::context::detail::jump_fcontext(main_tf.fctx, &z);

    printf("f1 end \n");
}

void foo_fn2(boost::context::detail::transfer_t t)
{
	int *x = (int *)t.data;

    printf("f2 begin %d %lx\n", *x, t.fctx);

	z = 102;
	printf("ccc %lx\n", (void *)t.fctx);
    foo1_tf = boost::context::detail::jump_fcontext(t.fctx, &z);

	int *y = (int *)t.data;
    printf("back f2 %d %d %lx %lx\n", *x, *y, t.fctx, foo1_tf.fctx);
...
int main()
{
	...
	stack2 = (char *)malloc(40960);

	foo_stack1 = stack1;
	foo_stack2 = stack2;

	foo_stack1 = (char *)((long int)(foo_stack1 + 511) & 0xfffffffffffffff0);
	foo_stack2 = (char *)((long int)(foo_stack2 + 511) & 0xfffffffffffffff0);

	foo1_tf.fctx = boost::context::detail::make_fcontext(foo_stack1, 512, foo_fn1);
	foo2_tf.fctx = boost::context::detail::make_fcontext(foo_stack2, 512, foo_fn2);
